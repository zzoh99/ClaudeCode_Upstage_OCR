...
export default function ParsePreview({ data, onSave, onCancel, saving }) {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 space-y-6 animate-slide-up">
      {/* 헤더 */}
